...
function RoleModalBody(_a) {
    ...
    return (react_1["default"].createElement("div", { className: "flex flex-col mx-2 my-4 gap-4" },
        ...
        react_1["default"].createElement("div", { className: "flex items-center w-full mt-6 justify-between" },
