...
var SelectTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(SelectPrimitive.Trigger, __assign({ ref: ref, className: utils_1.cn("flex h-10 w-full items-center justify-between rounded-md border border-blue-500 border-slate-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:border-slate-800 dark:bg-slate-950 dark:ring-offset-slate-950 dark:placeholder:text-slate-400 dark:focus:ring-slate-300", className) }, props),
        children,
...
var SelectSeparator = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SelectPrimitive.Separator, __assign({ ref: ref, className: utils_1.cn("-mx-1 my-1 h-px bg-slate-100 dark:bg-slate-800", className) }, props)));
});
