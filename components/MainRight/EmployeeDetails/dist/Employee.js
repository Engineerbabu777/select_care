...
function EmployeeDetail() {
    ...
    return (React.createElement(React.Fragment, null,
        !(employee === null || employee === void 0 ? void 0 : employee.selectedOne) && (React.createElement(SelectAny_1["default"], { title: "Select an Employee", desc: "Select an employee to see its details here." })),
        (employee === null || employee === void 0 ? void 0 : employee.selectedOne) && (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "h-full w-full overflow-scroll no-scroll flex flex-col" },
                React.createElement(CardHeading_1["default"], { employee: employee, edit: edit, setEdit: setEdit, setShowDelete: setShowDelete, showDelete: showDelete, deleteFunction: deleteEmployee, employeeView: true }),
                ...
                React.createElement("div", { className: "p-4 flex flex-col gap-8 flex-1" },
                    ...
                    React.createElement("div", { className: "flex-1" },
                        React.createElement(ActionButtons_1["default"]
                        // editRole={}
                        , { 
                            // editRole={}
                            employee: employee, setEmployee: setEmployee, setEdit: setEdit, edit: edit, editEmployee: editEmployee }))))))));
}
