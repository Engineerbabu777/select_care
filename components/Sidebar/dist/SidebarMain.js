...
function SidebarMain() {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Modal_1["default"], { showModal: isOpen, header: "Create New User", body: React.createElement(Body_1["default"], { closeModal: toggleModal }) }),
            ...
            React.createElement(Card_1["default"], null,
                React.createElement("div", { className: "mt-4 px-1 gap-2 flex flex-col items-center  " },
                    React.createElement("div", { className: "" },
                        React.createElement(IconComponent_1["default"], { isClickable: true, onClick: toggleModal, aside: true, icon: React.createElement(icons_1.IoIosAddCircle, { className: "w-8 m-1 h-8 text-[#016A70]" }) })),
