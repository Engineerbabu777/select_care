            ...
            React.createElement(Card_1["default"], null,
                React.createElement("div", { className: "mt-4 px-1 gap-2 flex flex-col items-center  " },
                    ...
                    React.createElement("div", { className: "-mb-1" },
                        React.createElement(IconComponent_1["default"], { isClickable: true, onClick: function () { return setDisplay({ right: "", display: "USER" }); }, aside: true, icon: React.createElement(icons_1.RiGroup2Fill, { className: "w-7 h-7 m-1.5 " +
                                    ((display === null || display === void 0 ? void 0 : display.display) === "USER" && (display === null || display === void 0 ? void 0 : display.right) === ""
                                        ? "text-orange-800"
                                        : "") }) })),
                    React.createElement("div", { className: "" },
                        React.createElement(IconComponent_1["default"], { isClickable: true, onClick: function () { return setDisplay({ right: "", display: "ROLE" }); }, aside: true, icon: React.createElement(icons_1.FaIdCardClip, { className: "w-6 h-6 m-2 " +
                                    ((display === null || display === void 0 ? void 0 : display.display) === "ROLE" && (display === null || display === void 0 ? void 0 : display.right) === ""
                                        ? "text-orange-800"
                                        : "") }) })),
                    React.createElement("div", { className: "" },
                        React.createElement(IconComponent_1["default"], { isClickable: true, onClick: function () {
                                return setDisplay({ right: "SUNSUSER", display: "USER" });
                            }, aside: true, icon: React.createElement(icons_1.MdCompost, { className: "w-6 h-6 m-2 " +
                                    ((display === null || display === void 0 ? void 0 : display.display) === "USER" &&
                                        (display === null || display === void 0 ? void 0 : display.right) === "SUNSUSER"
                                        ? "text-orange-800"
                                        : "") }) })),
                    React.createElement("div", { className: "" },
                        React.createElement(IconComponent_1["default"], { isClickable: true, onClick: function () {
                                return setDisplay({ right: "SUNSROLE", display: "ROLE" });
                            }, aside: true, icon: React.createElement(icons_1.MdOutlineCompare, { className: "w-6 h-6 m-2 " +
                                    ((display === null || display === void 0 ? void 0 : display.display) === "ROLE" &&
                                        (display === null || display === void 0 ? void 0 : display.right) === "SUNSROLE"
                                        ? "text-orange-800"
                                        : "") }) })),
                    React.createElement("div", { className: "" },
                        React.createElement(IconComponent_1["default"], { isClickable: true, onClick: function () { return setDisplay({ right: "", display: "DEV" }); }, aside: true, icon: React.createElement(icons_1.MdEngineering, { className: "w-6 h-6 m-2 " +
